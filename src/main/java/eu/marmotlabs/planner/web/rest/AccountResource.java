...
import eu.marmotlabs.planner.domain.PersistentToken;
import eu.marmotlabs.planner.domain.User;
import eu.marmotlabs.planner.repository.PersistentTokenRepository;
import eu.marmotlabs.planner.repository.UserRepository;
import eu.marmotlabs.planner.security.SecurityUtils;
import eu.marmotlabs.planner.service.MailService;
import eu.marmotlabs.planner.service.UserService;
import eu.marmotlabs.planner.web.rest.dto.KeyAndPasswordDTO;
import eu.marmotlabs.planner.web.rest.dto.ManagedUserDTO;
import eu.marmotlabs.planner.web.rest.dto.UserDTO;
